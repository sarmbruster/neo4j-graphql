...
To auto-generate a schema inferred from graph contents you might use

[source,cypher]
----
call graphql.generateSchema()
----

This will perform a full graph scan and touch every node. Optionally you can reduce the number of scanned nodes per label:

[source,cypher]
----
call graphql.generateSchema(100)
----
